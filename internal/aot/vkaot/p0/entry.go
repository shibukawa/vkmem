...
func F_entryConstruct(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32) int32 {
	...
	if base.B2i32(l2 != v11)&base.B2i32(l3 == v11) != 0 {
			...
			if l5 != 0 {
				if l2 == int32(0) {
					...
					if v120 != 0 {
						...
						v151 = *(*int32)(unsafe.Add(mBase, _consts[122]))
						if v151 == int32(0) {
							m.G0 = v17 + int32(16)
							return v119
						} else {
							...
							if l5 == base.B2i32(v155 != int32(0))&int32(base.Ui32(v148&int32(16))>>(uint(int32(4))%32)) {
								F__serverAssert(m, int32(_a543), int32(_a544), int32(344))
								mBase = m.M
								v186 = m.ExcPending
								if v186 != 0 {
									return int32(0)
								...
								if v169 != v147 {
									F__serverAssert(m, int32(_a545), int32(_a544), int32(345))
									mBase = m.M
									v192 = m.ExcPending
									if v192 != 0 {
										return int32(0)
		...
		if base.B2i32(l2|l3 == int32(0))&l5 != 0 {
			...
			if l2 != 0 {
				F__serverAssert(m, int32(_a546), int32(_a544), int32(312))
				mBase = m.M
				v180 = m.ExcPending
				if v180 != 0 {
					return int32(0)
...
func F_entryCreate(m *base.Module, l0 int32, l1 int32, l2 int64) int32 {
	...
	if base.Ui32(int32(4)) < base.Ui32(v79) {
		...
		v86 = *(*int32)(unsafe.Add(mBase, uint32(v79<<(uint(int32(2))%32))+uint32(_consts[251])))
		v87 = v86
	}
	v89 = v57 + int32(1)
	v90 = v87 + v89
	...
	if v35 != int32(-1) {
		v109 = *(*int32)(unsafe.Add(mBase, _consts[249]))
		...
		if base.Ui32(v115) < base.Ui32(int32(129)) {
			...
			v118 = int32(0)
			if v75 == v118 {
				v135 = *(*int32)(unsafe.Add(mBase, _consts[249]))
				v137 = v135 + v89
...
func F_entryFreeValuePtr(m *base.Module, l0 int32) {
	...
	if v6&int32(7) == int32(0) {
		F__serverAssert(m, int32(_a547), int32(_a544), int32(175))
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return
		...
		if v6&int32(16) == int32(0) {
			...
			if base.Ui32(int32(4)) < base.Ui32(v22) {
				...
				v29 = *(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(int32(2))%32))+uint32(_consts[250])))
				v30 = v29
			}
			v33 = l0 + v30 + int32(-4)
	...
	if v8&int32(7) == int32(0) {
		...
		if v8&int32(8) == int32(0) {
			...
			if base.Ui32(int32(4)) < base.Ui32(v24) {
				...
				v31 = *(*int32)(unsafe.Add(mBase, uint32(v24<<(uint(int32(2))%32))+uint32(_consts[250])))
				v32 = v31
			}
...
func F_entryGetValue(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v10 == int32(0) {
		...
		v43 = *(*int32)(unsafe.Add(mBase, _consts[249]))
		v45 = l0 + v30 + v43
		v47 = v45 + int32(1)
		if l1 == int32(0) {
			v138 = v47
		...
		if v8&int32(16) != 0 {
			...
			if base.Ui32(int32(4)) < base.Ui32(v88) {
				...
				v95 = *(*int32)(unsafe.Add(mBase, uint32(v88<<(uint(int32(2))%32))+uint32(_consts[250])))
				v96 = v95
			}
			v99 = l0 + v96 + int32(-4)
