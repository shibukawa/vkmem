...
func F_luaB_coresume(m *base.Module, l0 int32) int32 {
	...
	if v63 != 0 {
		...
		v65 = m.G3
		v68 = F_luaL_argerror(m, l0, int32(1), v65+int32(_a_F_luaB_coresume_0))
		mBase = m.M
		v71 = m.ExcPending
		if v71 != 0 {
			return int32(0)
...
func F_luaB_costatus(m *base.Module, l0 int32) int32 {
	...
	if v69 != 0 {
		...
		v148 = m.G3
		v154 = *(*int32)(unsafe.Add(mBase, uint32(v148+int32(_a_F_luaB_costatus_0)+v147<<(uint(int32(2))%32))))
		...
		v71 = m.G3
		v74 = F_luaL_argerror(m, l0, int32(1), v71+int32(_a_F_luaB_costatus_1))
		mBase = m.M
		v77 = m.ExcPending
		if v77 != 0 {
			return int32(0)
...
func F_luaB_getmetatable(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		if v79 != 0 {
			v102 = m.G3
			v105 = F_luaL_getmetafield(m, l0, int32(1), v102+int32(_a_F_luaB_getmetatable_0))
			mBase = m.M
			v106 = m.ExcPending
			if v106 != 0 {
				return int32(0)
...
func F_luaB_load(m *base.Module, l0 int32) int32 {
	...
	_ = v142
	v6 = m.G3
	v10 = F_luaL_optlstring(m, l0, int32(2), v6+int32(_a_F_luaB_load_0), int32(0))
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return int32(0)
...
L1:
	;
	F_lua_getfield(m, l0, int32(-10002), v6+int32(_a_F_luaB_print_0))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L2
...
L4:
	;
	v391 = m.G3
	v395 = F_luaL_error(m, l0, v391+int32(_a_F_luaB_print_1), int32(0))
	mBase = m.M
	v396 = m.ExcPending
	if v396 != 0 {
		goto L2
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+8)) = v73 + int32(16)
			...
			if v79 != 0 {
				...
				if v78 == int32(0) {
					...
					if v350 != 0 {
						v459 = m.G3
						v463 = F_luaL_error(m, l0, v459+int32(_a_F_luaB_setfenv_0), int32(0))
						mBase = m.M
						v464 = m.ExcPending
						if v464 != 0 {
							return int32(0)
		...
		if v12 != int32(10) {
			...
			if v41 != 0 {
				...
				if base.Ui32(v12+int32(-2)) < base.Ui32(int32(35)) {
					...
					v47 = m.G3
					v50 = F_luaL_argerror(m, l0, int32(2), v47+int32(_a_F_luaB_tonumber_0))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
...
func F_luaB_tostring(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		v14 = m.G3
		v17 = F_luaL_callmeta(m, l0, int32(1), v14+int32(_a_F_luaB_tostring_0))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
			...
			if v17 != 0 {
				...
				case 0:
					v218 = m.G3
					F_lua_pushlstring(m, l0, v218+int32(_a_F_luaB_tostring_1), int32(3))
					mBase = m.M
					v223 = m.ExcPending
					if v223 != 0 {
						return int32(0)
				...
				case 1:
					...
					v211 = m.G3
					if v210 != 0 {
						v214 = int32(_a_F_luaB_tostring_2)
					} else {
						v214 = int32(_a_F_luaB_tostring_3)
					}
				...
				default:
					...
					if v281 != int32(-1) {
						...
						v293 = v283 + int32(_a_F_luaB_tostring_4)
					}
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v293
					v425 = m.G3
					v428 = F_lua_pushfstring(m, l0, v425+int32(_a_F_luaB_tostring_5), v6)
					mBase = m.M
					v429 = m.ExcPending
					if v429 != 0 {
						return int32(0)
...
func F_luaB_type(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		if v64 != int32(-1) {
			...
			v76 = v66 + int32(_a_F_luaB_type_0)
		}
