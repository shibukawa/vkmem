...
L24:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v13)+30)) = uint16(v218)
	...
	v226 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(27))%32)))+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+24)) = uint8(v226)
	v230 = int32(31)
	v234 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(2))%32))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+29)) = uint8(v234)
	v242 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(7))%32))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+28)) = uint8(v242)
	v250 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(12))%32))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+27)) = uint8(v250)
	v258 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(17))%32))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+26)) = uint8(v258)
	v266 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v221)>>(uint(int32(22))%32))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+25)) = uint8(v266)
	v275 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(int64(base.Ui64(v220)>>(uint(int64(32))%64)))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+23)) = uint8(v275)
	v284 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(int64(base.Ui64(v220)>>(uint(int64(37))%64)))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+22)) = uint8(v284)
	v293 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(int64(base.Ui64(v220)>>(uint(int64(42))%64)))&v230)+uint32(_c_F_geohashCommand[0]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v13)+21)) = uint8(v293)
	v302 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(int64(base.Ui64(v220)>>(uint(int64(47))%64)))&v230)+uint32(_c_F_geohashCommand[0]))))
