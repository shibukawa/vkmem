...
func F_AddReplyFromClient(m *base.Module, l0 int32, l1 int32) {
	...
	if v10&int32(1024) == int32(0) {
		if v10&int32(16777216) != 0 {
			F__serverAssert(m, int32(_a996), int32(_a977), int32(1742))
			mBase = m.M
			v130 = m.ExcPending
			if v130 != 0 {
				return
				...
				if v21&int32(1280) != 0 {
					...
					if int32(3) < v40 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
						F__serverLog(m, int32(3), int32(_a997), v8)
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return
					...
					*(*int32)(unsafe.Add(mBase, uint32(l0)+200)) = v21 | int32(1024)
					...
					if v28 == int32(0) {
						v36 = *(*int32)(unsafe.Add(mBase, _consts[593]))
						...
						v32 = *(*int32)(unsafe.Add(mBase, _consts[593]))
						...
						if v48&int32(1) != 0 {
							...
							if v48&int32(2) == int32(0) {
								if v48&int32(262144) != 0 {
									v67 = int32(_a44)
									v68 = *(*int32)(unsafe.Add(mBase, _consts[509]))
									v72 = *(*int32)(unsafe.Add(mBase, _consts[436]))
		...
		if v130 != 0 {
			...
			if v132 != 0 {
				...
				if v136&int32(1) != 0 {
					...
					v149 = *(*int64)(unsafe.Add(mBase, _consts[590]))
...
func F_addReplyBool(m *base.Module, l0 int32, l1 int32) {
	...
	if v3 != int32(2) {
		...
		v11 = *(*int32)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[84])))
		F_addReply(m, l0, v11)
		mBase = m.M
		v13 = m.ExcPending
		if v13 != 0 {
...
L8:
	;
	F__addReplyToBufferOrList(m, l0, int32(_a994), int32(5))
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		goto L4
...
L10:
	;
	F__addReplyToBufferOrList(m, l0, int32(_a995), int32(3))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		goto L4
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v37
	F_addReplyStatusFormat(m, l0, int32(_a70), v12)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L9:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _consts[12]))
	v46 = v27 + int32(1)
	v47 = v45
	goto L7
L10:
...
L12:
	;
	F_addReplyBulkCString(m, l0, int32(_a1614))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v60
	F__serverPanic_1(m, int32(_a1555), int32(5281), int32(_a1617), v9)
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L23:
	;
	F_addReplyBulkCString(m, l0, int32(_a96))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L24:
	;
	F_addReplyBulkCString(m, l0, int32(_a1618))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L25:
	;
	F_addReplyBulkCString(m, l0, int32(_a1619))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L1
...
L31:
	;
	F_addReplyBulkCString(m, l0, int32(_a1620))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L36:
	;
	F_addReplyBulkCString(m, l0, int32(_a1621))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L1
...
L41:
	;
	F_addReplyBulkCString(m, l0, int32(_a288))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v225
	F__serverPanic_1(m, int32(_a1555), int32(5322), int32(_a1622), v9+int32(16))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L1
...
L52:
	;
	F_addReplyBulkCString(m, l0, int32(_a1623))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L55:
	;
	F_addReplyBulkCString(m, l0, int32(_a1624))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L1
...
L57:
	;
	F_addReplyBulkCString(m, l0, int32(_a1625))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L1
...
L59:
	;
	F_addReplyBulkCString(m, l0, int32(_a586))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L63:
	;
	F_addReplyBulkCString(m, l0, int32(_a1626))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L1
...
L66:
	;
	F_addReplyBulkCString(m, l0, int32(_a1627))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L1
...
L68:
	;
	F_addReplyBulkCString(m, l0, int32(_a1628))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L1
...
func F_addReplyErrorExpireTime(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v8
	F_addReplyErrorFormat(m, l0, int32(_a989), v5)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return
...
L14:
	;
	v60 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v54)+uint32(_consts[549]))))
...
L17:
	;
	v63 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v54)+uint32(_consts[383]))))
...
func F_addReplyLongLong(m *base.Module, l0 int32, l1 int64) {
	...
	if base.Ui64(int64(1)) < base.Ui64(l1) {
		...
		case 1:
			v17 = *(*int32)(unsafe.Add(mBase, _consts[347]))
			F_addReply(m, l0, v17)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+204)) = v6 | int32(131072)
	...
	if v10 != int32(2) {
		...
		if v19 != 0 {
			...
			v21 = *(*int32)(unsafe.Add(mBase, _consts[614]))
			F_addReply(m, l0, v21)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
		...
		v14 = *(*int32)(unsafe.Add(mBase, _consts[615]))
		F_addReply(m, l0, v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+204)) = v4 | int32(131072)
	...
	if v8 != int32(2) {
		...
		if v17 != 0 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[617]))
			F_addReply(m, l0, v19)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
		...
		v12 = *(*int32)(unsafe.Add(mBase, _consts[616]))
		F_addReply(m, l0, v12)
		mBase = m.M
		v14 = m.ExcPending
		if v14 != 0 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+204)) = v4 | int32(131072)
	...
	if v8 != int32(2) {
		...
		if v17 != 0 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[618]))
			F_addReply(m, l0, v19)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
...
func F_addReplyPubsubUnsubscribed(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+204)) = v5 | int32(131072)
	...
	if v9 != int32(2) {
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[616]))
		F_addReply(m, l0, v13)
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
...
L6:
	...
	v21 = int32(0)
	v22 = *(*int32)(unsafe.Add(mBase, _consts[734]))
...
L9:
	;
	F_addReplyBulkCString(m, l0, int32(_a1464))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L1
...
L17:
	;
	v55 = F_sdscat(m, v7, int32(_a1494))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L20:
	;
	v65 = F_sdscat(m, v58, int32(_a1495))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L23:
	;
	v75 = F_sdscat(m, v68, int32(_a280))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L26:
	;
	v85 = F_sdscat(m, v78, int32(_a281))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L29:
	;
	v95 = F_sdscat(m, v88, int32(_a1496))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L32:
	;
	v103 = F_sdscat(m, v97, int32(_a1497))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L35:
	;
	v112 = F_sdscat(m, v105, int32(_a1498))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L1
...
L38:
	;
	v122 = F_sdscat(m, v115, int32(_a1499))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L1
...
L41:
	;
	v132 = F_sdscat(m, v125, int32(_a1500))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L1
...
L44:
	;
	v142 = F_sdscat(m, v135, int32(_a1501))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L1
...
L47:
	;
	v152 = F_sdscat(m, v145, int32(_a1502))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L50:
	;
	v162 = F_sdscat(m, v155, int32(_a1503))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L53:
	;
	v172 = F_sdscat(m, v165, int32(_a1504))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L1
...
L56:
	;
	v182 = F_sdscat(m, v175, int32(_a1505))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L59:
	;
	v192 = F_sdscat(m, v185, int32(_a1506))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L1
...
L62:
	;
	v202 = F_sdscat(m, v195, int32(_a1507))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L1
...
L107:
	;
	F_addReplyBulkCString(m, l0, int32(_a1465))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L1
...
L109:
	;
	F_addReplyBulkCString(m, l0, int32(_a1466))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L1
...
L112:
	;
	F_addReplyBulkCString(m, l0, int32(_a1467))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L1
...
L113:
	;
	F_addReplyBulkCString(m, l0, int32(_a1508))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L1
...
L116:
	;
	v365 = *(*int32)(unsafe.Add(mBase, uint32(v358<<(uint(int32(2))%32))+uint32(_consts[770])))
	v366 = v365
	goto L115
L117:
	;
...
L122:
	;
	F_addReplyBulkCString(m, l0, int32(_a1468))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L124:
	;
	F_addReplyBulkCString(m, l0, int32(_a1469))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L1
...
L128:
	;
	F_addReplyBulkCString(m, l0, int32(_a1509))
	mBase = m.M
	v414 = m.ExcPending
	if v414 != 0 {
		goto L1
...
L131:
	;
	F_addReplyBulkCString(m, l0, int32(_a1470))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L1
...
L132:
	;
	F_addReplyBulkCString(m, l0, int32(_a1510))
	mBase = m.M
	v431 = m.ExcPending
	if v431 != 0 {
		goto L1
...
L138:
	;
	F_addReplyBulkCString(m, l0, int32(_a1471))
	mBase = m.M
	v453 = m.ExcPending
	if v453 != 0 {
		goto L1
...
L144:
	;
	F_addReplyBulkCString(m, l0, int32(_a1472))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L1
...
L149:
	;
	F_addReplyBulkCString(m, l0, int32(_a1473))
	mBase = m.M
	v479 = m.ExcPending
	if v479 != 0 {
		goto L1
...
L153:
	;
	F_addReplyBulkCString(m, l0, int32(_a1486))
	mBase = m.M
	v497 = m.ExcPending
	if v497 != 0 {
		goto L1
...
L155:
	;
	F_addReplyBulkCString(m, l0, int32(_a1487))
	mBase = m.M
	v503 = m.ExcPending
	if v503 != 0 {
		goto L1
...
L157:
	;
	F_addReplyBulkCString(m, l0, int32(_a1488))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L1
...
L159:
	;
	F_addReplyBulkCString(m, l0, int32(_a1489))
	mBase = m.M
	v523 = m.ExcPending
	if v523 != 0 {
		goto L1
...
L161:
	;
	F_addReplyBulkCString(m, l0, int32(_a1490))
	mBase = m.M
	v529 = m.ExcPending
	if v529 != 0 {
		goto L1
...
L163:
	;
	F_addReplyBulkCString(m, l0, int32(_a1491))
	mBase = m.M
	v535 = m.ExcPending
	if v535 != 0 {
		goto L1
...
L167:
	;
	F_addReplyBulkCString(m, l0, int32(_a1492))
	mBase = m.M
	v544 = m.ExcPending
	if v544 != 0 {
		goto L1
...
L171:
	;
	F_addReplyBulkCString(m, l0, int32(_a1493))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
...
L175:
	;
	F_addReplyBulkCString(m, l0, int32(_a1477))
	mBase = m.M
	v571 = m.ExcPending
	if v571 != 0 {
		goto L1
...
L177:
	;
	F_addReplyBulkCString(m, l0, int32(_a1478))
	mBase = m.M
	v577 = m.ExcPending
	if v577 != 0 {
		goto L1
...
L182:
	;
	F_addReplyBulkCString(m, l0, int32(_a1481))
	mBase = m.M
	v586 = m.ExcPending
	if v586 != 0 {
		goto L1
...
L187:
	;
	F_addReplyBulkCString(m, l0, int32(_a1482))
	mBase = m.M
	v594 = m.ExcPending
	if v594 != 0 {
		goto L1
...
L189:
	;
	F_addReplyBulkCString(m, l0, int32(_a1483))
	mBase = m.M
	v600 = m.ExcPending
	if v600 != 0 {
		goto L1
...
L191:
	;
	F_addReplyBulkCString(m, l0, int32(_a1484))
	mBase = m.M
	v606 = m.ExcPending
	if v606 != 0 {
		goto L1
...
L193:
	;
	F_addReplyBulkCString(m, l0, int32(_a1485))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L1
...
L197:
	;
	F_addReplyBulkCString(m, l0, int32(_a1474))
	mBase = m.M
	v627 = m.ExcPending
	if v627 != 0 {
		goto L1
...
L199:
	;
	F_addReplyBulkCString(m, l0, int32(_a1475))
	mBase = m.M
	v635 = m.ExcPending
	if v635 != 0 {
		goto L1
...
L204:
	;
	F_addReplyBulkCString(m, l0, int32(_a1476))
	mBase = m.M
	v643 = m.ExcPending
	if v643 != 0 {
		goto L1
...
func F_replyEngineStats(m *base.Module, l0 int32, l1 int32) {
	...
	if v5 != 0 {
		...
		if v8 != 0 {
			...
			v10 = *(*int32)(unsafe.Add(mBase, _consts[423]))
			...
			if v14 != 0 {
				...
				F_addReplyBulkCString(m, l1, int32(_a798))
				mBase = m.M
				v17 = m.ExcPending
				if v17 != 0 {
					return
					...
					if v13 == int32(0) {
						...
						if v31 != 0 {
							...
							F_addReplyBulkCString(m, l1, int32(_a799))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return
